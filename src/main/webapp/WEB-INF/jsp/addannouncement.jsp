...
<div class="container h-100">
    <div class="container-fluid w-60">
        <form class="p-5  shadow-lg" action="addannouncement" method="post">
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">标题</label>
                <textarea name="head" id="exampleInputEmail1" style="width: 100%" required></textarea>
            ...
            <div class="mb-3">
                ...
                <textarea name="content" id="exampleInputPassword1" style="width: 100%;height: 300px" required></textarea>
